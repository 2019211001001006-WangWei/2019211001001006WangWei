			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.WangWei.model.Order o=(com.WangWei.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.WangWei.dao.UserDao userDao=new com.WangWei.dao.UserDao();
						...
						<%
							...
							String paymentType=com.WangWei.model.Payment.findByPaymentId(con,n);
							 %>
